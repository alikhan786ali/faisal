...
function App() {
  ...
  const s2 = "/images/sst2.webp";
  const s3 = "/images/sst3.webp";
  const s4 = "/images/sst4.webp";
  const s5 = "/images/sst5.webp";
  const s6 = "/images/sst6.webp";
      ...
      {loading ? (
        <div className="fixed inset-0 bg-white flex flex-col items-center justify-center z-50">
          <div className="w-24 h-24 mb-4">
            <img src="/faisal_logo.jpg" alt="Faisal DigiBank Logo" className="w-full h-full object-contain rounded-full" />
          </div>
          <h1 className="text-2xl font-bold text-green-700 mb-2">Faisal DigiBank</h1>
        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white font-sans text-gray-800 w-screen max-w-[100vw] overflow-x-hidden px-4 sm:px-6 lg:px-8 box-border">
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-blue-50">
                  This is an unofficial distribution page for the Faisal DigiBank app. This app is intended for educational and demonstration purposes only.
                </p>
          ...
          <header className="bg-white shadow-md sticky top-0 z-40">
            <div className="container mx-auto px-4 py-3 flex justify-between items-center">
              <div className="flex items-center">
                <img src="/faisal_logo.jpg" alt="Faisal DigiBank Logo" className="w-10 h-10 object-contain" />
                <span className="text-xl font-semibold ml-2 text-green-700">Faisal DigiBank</span>
              </div>
              <button 
            ...
            <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
              <div className="text-center md:text-left md:w-1/2 mb-8 md:mb-0">
                ...
                <p className="text-base md:text-lg text-gray-600 mb-6 max-w-lg mx-auto md:mx-0">
                  Experience Islamic banking at your fingertips with Faisal DigiBank - your trusted financial partner.
                </p>
                <motion.button 
              ...
              <div className="md:w-1/2 flex justify-center mt-8 md:mt-0">
                <motion.img 
                  src="/images/faisal_hero.jpg" 
                  alt="Faisal DigiBank App Hero Image" 
          ...
          <section id="screenshots" className="py-8 md:py-16 bg-gray-50">
            <div className="container mx-auto px-4">
              <div className="text-center mb-8 md:mb-12">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto text-sm md:text-base">Take a look at the sleek and intuitive interface of the Faisal DigiBank app.</p>
              </div>
          ...
          <section id="download" className="py-8 md:py-16 bg-gradient-to-b from-white to-gray-100">
            <div className="container mx-auto px-4 text-center">
              <h2 className="text-2xl md:text-3xl font-bold text-green-800 mb-2">Get Faisal DigiBank App Now</h2>
          ...
          <footer className="bg-gray-900 text-white py-12">
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                  <div className="flex items-center mb-4">
                    <img src="/faisal_logo.jpg" alt="Faisal DigiBank Logo" className="w-10 h-10 object-contain rounded-full" />
                    <span className="text-xl font-semibold ml-2 text-green-400">Faisal DigiBank</span>
                  </div>
                  <p className="text-gray-400 mb-4 text-sm md:text-base">
                    Faisal DigiBank provides secure and convenient Islamic banking services on your smartphone. 
                ...
                <div>
                  ...
                  <div className="space-y-3 text-sm md:text-base">
                    <div className="flex items-start">
                      ...
                      <span className="font-medium">app@faisalbank.com</span>
                    </div>
                    <div className="flex items-start">
                    ...
                    <div className="flex items-start">
                      ...
                      <span className="font-medium">Faisal Bank Head Office, Karachi, Pakistan</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
                <p className="text-gray-400 mb-4 md:mb-0 text-sm md:text-base"> {new Date().getFullYear()} Faisal DigiBank. All rights reserved.</p>
